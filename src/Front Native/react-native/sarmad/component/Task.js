...
const [toDate, settoDate] = useState('')
  ...
  {item.count >0  }
       {/* <Text>{item.catg}</Text> */}
        ...
        <Text style={{fontSize:20,fontweight:"bold",marginLeft:5}}>Name Ali: {item.Name}</Text>
        <Text style={{fontSize:20,fontweight:"bold",marginLeft:5}}>Distance 5 km: {item.Distance}</Text>
